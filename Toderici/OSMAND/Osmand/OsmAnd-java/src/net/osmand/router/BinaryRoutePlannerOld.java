...
//		return measuredDist(x1, y1, x2, y2);
	 ...
	 */
	void searchRouteInternal(final RoutingContext ctx, RouteSegment start, RouteSegment end, TrafficDataSet traffic, long delay) throws IOException, InterruptedException {
		// measure time
		ctx.timeToLoad = 0;
